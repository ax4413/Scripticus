...
function Get-KeyValutSecret($keyVault, $KeyName, [switch]$IncludeVersions){
...
if(!$x){ $x = Connect-AzureRmAccount}



Get-KeyValutSecret -keyvault $kv -KeyName  $key -IncludeVersions | Format-Table -AutoSize
