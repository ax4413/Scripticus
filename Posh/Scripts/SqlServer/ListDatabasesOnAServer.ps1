# List DBs On a server
# list of servers identified in a file format {Data Source=192.168.20.81;User ID=sa;Password=0pt1c5##;MultipleActiveResultSets=False}
# out put results to excell
...
foreach ($instance in get-content "C:\SQL_Servers.txt")
{
     ...
     $intRow++
	  ...
	  #$Sheet.Cells.Item($intRow,8) = "KEEP DB"
