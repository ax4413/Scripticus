...
/*
We need to add GO stmts cause the dev didn't know they needed it.
1.  First we need to standardize the CREATE PROCEDURE.

Search for: CREATE:b+proc(edure)*
Replace with: CREATE PROCEDURE
...
2.  Now we need to add the GO stmts.
