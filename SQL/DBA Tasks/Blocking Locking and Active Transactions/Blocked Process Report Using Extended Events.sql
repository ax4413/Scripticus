/* 
    Find and replace with valid writable paths:
        y:\blocked_process*.xel
        y:\blocked_process*.xem
...
/* ------------------------------------------------------------------------------------------------------- */
/* Create the stored procedure toconsume the blocked process report with */
...
(SET filename = N'y:\blocked_process.xel',
     metadatafile = N'y:\blocked_process.xem',
     max_file_size=(65536),
...
/* ------------------------------------------------------------------------------------------------------- */
/* View the data using teh blocked process report tool */
